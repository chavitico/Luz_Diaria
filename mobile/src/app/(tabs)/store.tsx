...
import CromosCard from '@/components/store/cards/CromosCard';
import FeatureCard from '@/components/store/cards/FeatureCard';
import CollectionTicker from '@/components/store/ui/CollectionTicker';
import SeasonBanner from '@/components/store/banners/SeasonBanner';
import LaunchEventBanner from '@/components/store/banners/LaunchEventBanner';
import DueloSabiduriaCard from '@/components/store/banners/DueloSabiduriaCard';
import SeasonalAdventureCard from '@/components/store/banners/SeasonalAdventureCard';
import ProfileHeader from '@/components/store/ui/ProfileHeader';
import WeeklyChestCard from '@/components/store/cards/WeeklyChestCard';
import WeeklyChallengesCard from '@/components/store/cards/WeeklyChallengesCard';
import PromoCodeCard from '@/components/store/cards/PromoCodeCard';
import CategoryCard from '@/components/store/cards/CategoryCard';
import ChapterCollectionCard from '@/components/store/cards/ChapterCollectionCard';
import CollectionCard from '@/components/store/cards/CollectionCard';
import PointsToast from '@/components/store/ui/StorePointsToast';
import DailyPackBanner from '@/components/store/banners/DailyPackBanner';
        ...
        >
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginBottom: 12 }}>
            ...
            >
              ...
              >
                <Image
                  source={{ uri: 'https://images.unsplash.com/photo-1572635148818-ef6fd45eb394?w=800&q=80' }}
