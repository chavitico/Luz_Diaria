...
export function EasterPackCard({
  ...
  if (compact) {
    return (
      <View style={{ flex: 1, opacity: disabled ? 0.5 : isEventActive ? 1 : 0.65 }}>
        <Animated.View style={animStyle}>
          ...
          >
            <LinearGradient
              ...
              style={{ borderRadius: 18, padding: 14, paddingTop: 16, borderWidth: 1.5, borderColor: '#B22A2A', overflow: 'hidden', alignItems: 'center' }}
            >
              ...
              <View style={{ shadowColor: '#FFD700', shadowOpacity: 0.60, shadowRadius: 12, shadowOffset: { width: 0, height: 0 }, elevation: 10, marginBottom: 10 }}>
                <Image source={require('../../../../assets/packs/pack_pascua_pack.png')} style={{ width: 60, height: 82 }} resizeMode="contain" />
              </View>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3, marginBottom: 10 }}>
                <Coins size={12} color={isEventActive && canAfford ? '#D4AF37' : '#555'} />
                <Text style={{ fontSize: sFont(16), fontWeight: '900', color: isEventActive && canAfford ? '#D4AF37' : '#555' }}>500</Text>
              </View>
              <LinearGradient
                colors={isEventActive && canAfford ? ['#B22A2A', '#8A1A1A'] : ['rgba(255,255,255,0.10)', 'rgba(255,255,255,0.06)']}
              ...
              >
                <Pressable onPress={onPress} style={{ paddingVertical: 9, alignItems: 'center', borderRadius: 99 }}>
                  <Text style={{ fontSize: sFont(12), fontWeight: '800', color: isEventActive && canAfford ? '#FFFFFF' : 'rgba(255,255,255,0.30)' }}>
                    {!isEventActive
