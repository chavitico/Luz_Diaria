        ...
        <Animated.View style={animStyle}>
          ...
          >
            <LinearGradient
              ...
              style={{ borderRadius: 18, padding: 14, paddingTop: 16, borderWidth: 1.5, borderColor: '#1A4A8A', overflow: 'hidden', alignItems: 'center' }}
            >
              ...
              <View style={{ shadowColor: '#60A5FA', shadowOpacity: 0.60, shadowRadius: 12, shadowOffset: { width: 0, height: 0 }, elevation: 10, marginBottom: 10 }}>
                <Image source={require('../../../../assets/packs/pack_milagros_pack.png')} style={{ width: 60, height: 82 }} resizeMode="contain" />
              </View>
              ...
              >
                <Pressable onPress={onPress} style={{ paddingVertical: 9, alignItems: 'center', borderRadius: 99 }}>
                  <Text style={{ fontSize: sFont(12), fontWeight: '800', color: canAfford ? '#FFFFFF' : 'rgba(255,255,255,0.30)' }}>
