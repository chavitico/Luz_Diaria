...
export const gamificationApi = {
  ...
  async purchaseItem(userId: string, itemId: string): Promise<{ success: boolean; item?: StoreItem; newPoints?: number; drawnCard?: { cardId: string; wasNew: boolean } | null; drawnCards?: Array<{ cardId: string; wasNew: boolean }>; usedFreePack?: boolean; freePacksRemaining?: number; error?: string }> {
  ...
  async claimDailyPack(userId: string, packType: 'sobre_biblico' | 'pack_pascua' | 'pack_milagros' | 'pack_heroes'): Promise<{
    success: boolean;
